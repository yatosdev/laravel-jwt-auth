    ...
    <div class="page page-center">
      <div class="container-tight py-4">
        <div class="text-center mb-4">
          <a href="." class="navbar-brand navbar-brand-autodark"><img src="<?php echo url('/'); ?>/static/logo.svg" height="36" alt=""></a>
        </div>
        <form id="LoginForm" class="card card-md" autocomplete="off" onsubmit="return false">
          <div class="card-body">
            ...
            <div class="mb-2">
              ...
              <div class="input-group input-group-flat">
                ...
                <span class="input-group-text">
                  <a id="showpassword" href="#" class="link-secondary" title="Show password" data-bs-toggle="tooltip"><!-- Download SVG icon from http://tabler-icons.io/i/eye -->
            ...
            <p id="msg" class="text-center"></p>
              <button onclick="login()"  type="submit" class="btn btn-primary w-100">Sign in</button>
            </div>
          </div>
...
function login() {
    ...
    xhttp.open("POST", "<?php echo url('/'); ?>/api/login", true);
